...
<template>
    <a class="flex items-center" href="#">
        <img src="/demo/images/blueflask.jpg" class="w-2/12" alt="blueflask" style="margin-left: 4px" />

        <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">Let us handle your manufacturing needs</span>
    </a>
    <Button
        class="lg:!hidden"
        text
